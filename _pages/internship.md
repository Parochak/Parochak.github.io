...
/* 🔹 Section titles (e.g. "What I expected before joining") */
...
/* First section title shouldn't have extra top gap right under the main title */
.internship-title + .internship-body .internship-section-title:first-child {
  margin-top: 0;
}
</style>

<img src="/assets/img/internship_photo.jpeg" alt="Optik Consultancy Team" class="internship-photo">

<div class="internship-caption">
(Working with my team; the diorama at the front highlights one of the CBD regions, "Tweed Heads," where existing wastewater and water assets are predicted to be inundated by 2120, SLR 0.97m)
</div>

<div class="internship-card">
  <div class="internship-title">Reflection on My Internship at Optik Consultancy</div>
  <!-- <div class="internship-subtitle">Reflections on leadership, communication, and technical growth</div> -->
